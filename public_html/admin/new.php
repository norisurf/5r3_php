    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        <div class="lg:col-span-1">
            <div class="sticky top-24 space-y-4 rounded-3xl border border-gray-100 bg-white p-6 shadow-sm text-gray-800">
                ...
                <p class="text-xs text-gray-500">YahooオークションのHTMLソースを貼り付けて解析します。</p>
                <textarea id="html-input" placeholder="ここにHTMLを貼り付け..." class="h-64 w-full rounded-2xl border border-gray-200 p-4 text-sm focus:border-[#003366] focus:outline-none"></textarea>
                <button type="button" onclick="parseHtml()" id="parse-btn" class="flex w-full items-center justify-center gap-2 rounded-2xl bg-[#facc15] py-3 font-bold text-[#003366] transition-all hover:bg-[#eab308]">
