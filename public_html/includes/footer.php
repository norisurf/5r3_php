        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-sm text-slate-500 font-bold">
                        <li><a href="/sales.php#lease" class="hover:text-white transition-colors">リース・ローン案内</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-5 text-sm">
                        <li class="flex items-start">
                            ...
                            <span class="text-slate-500 font-medium"><?= SITE_ADDRESS ?></span>
                        </li>
                        ...
                        <li class="flex items-center">
                            <svg class="w-5 h-5 mr-3 text-slate-600 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                            <span class="text-slate-500 font-medium tracking-tight"><?= SITE_EMAIL ?></span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="border-t border-white/5 pt-10 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                <p class="text-[10px] text-slate-700 font-black uppercase tracking-[0.2em]">&copy; 5R3 CARS. All Rights Reserved.</p>
                <div class="flex space-x-8 text-[10px] text-slate-700 font-black uppercase tracking-widest">
                    <a href="#" class="hover:text-slate-400 transition-colors">Privacy Policy</a>
                    <a href="#" class="hover:text-slate-400 transition-colors">Company</a>
