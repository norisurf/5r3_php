    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div>
                ...
                <h4
                    class="text-base font-bold mb-6 border-l-4 border-slate-500 pl-3 uppercase tracking-widest text-slate-300">
                    Content</h4>
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm text-slate-400 font-bold">
                    ...
                    <li><a href="/delivery.php" class="hover:text-white transition-colors">全国陸送対応</a></li>
            ...
            <div>
                ...
                <ul class="space-y-5 text-sm">
                    ...
                    <li class="flex items-start">
                        ...
                        <svg class="w-5 h-5 mr-3 text-slate-500 shrink-0" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                        ...
                        <span
                            class="text-slate-400 font-medium"><?= defined('SITE_ADDRESS_STORAGE') ? SITE_ADDRESS_STORAGE : '' ?></span>
        ...
        <div
            class="border-t border-white/5 pt-10 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">

            <p class="text-[10px] text-slate-500 font-black uppercase tracking-[0.2em]">&copy; 5R3. All Rights Reserved.
            </p>
...
<button id="scroll-top-btn"
    class="scroll-top-btn fixed bottom-24 right-4 md:bottom-28 md:right-8 z-50 bg-slate-800 hover:bg-slate-700 text-white p-4 rounded-full shadow-lg transition-all hover:scale-110 active:scale-95"
    aria-label="トップへ戻る">
