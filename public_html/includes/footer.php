    ...
    <footer class="bg-slate-950 text-white pt-20 pb-10 border-t border-slate-900">
        <div class="container mx-auto px-4">
                ...
                <div>
                    ...
                    <ul class="space-y-5 text-sm">
                        <li class="flex items-start">
                            <svg class="w-5 h-5 mr-3 text-slate-600 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <li class="flex items-start">
                            ...
                            <span class="text-slate-500 font-medium"><?= defined('SITE_ADDRESS_STORAGE') ? SITE_ADDRESS_STORAGE : '' ?></span>
                        </li>
            ...
            <div class="border-t border-white/5 pt-10 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                <p class="text-[10px] text-slate-700 font-black uppercase tracking-[0.2em]">&copy; 5R3. All Rights Reserved.</p>
