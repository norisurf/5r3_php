...
<section class="relative pt-20 pb-16 md:pt-32 md:pb-24 bg-slate-950 text-white overflow-hidden">
    <div class="absolute top-0 right-0 w-full h-full opacity-10 pointer-events-none">
        <div class="absolute inset-0"
            style="background-image: radial-gradient(circle at center, #ffffff 1px, transparent 1px); background-size: 32px 32px;">
        </div>
    </div>
...
<section class="py-24 bg-slate-950 text-white border-y border-slate-800">
    <div class="container mx-auto px-4 text-center">
        <div class="mb-12">
            ...
            <p class="mt-4 text-slate-200 font-medium max-w-2xl mx-auto">商用車専門だからこそ、一般の買取店では評価しきれない「装備」や「状態」をプラス査定します。
            </p>
        </div>
        <div class="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 mt-12">
            ...
            foreach ($items as $item): ?>
                <div
                    class="bg-white/5 border border-white/10 py-4 rounded-xl font-bold text-sm tracking-widest text-slate-200">
                    <?= h($item) ?>
                </div>
            <?php endforeach; ?>
        </div>
        <p class="mt-12 text-slate-200 text-sm font-medium italic">※動作確認が取れるものに限ります</p>
    </div>
</section>
...
<section id="docs" class="py-24 bg-white">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div class="bg-slate-50 p-8 rounded-3xl border border-slate-100">
                <h3 class="text-xl font-bold mb-6 flex items-center text-slate-900">
                    <span
                        class="bg-slate-900 text-white w-8 h-8 rounded-lg flex items-center justify-center mr-3 text-sm">個</span>
                    個人の場合
                </h3>
                <ul class="space-y-4">
            ...
            <div class="bg-slate-50 p-8 rounded-3xl border border-slate-100">
                <h3 class="text-xl font-bold mb-6 flex items-center text-slate-900">
                    <span
                        class="bg-slate-900 text-white w-8 h-8 rounded-lg flex items-center justify-center mr-3 text-sm">法</span>
                    法人の場合
                </h3>
                <ul class="space-y-4">
        ...
        <div class="mt-12 text-center">
            <p
                class="inline-block bg-slate-100 text-slate-700 px-6 py-3 rounded-full font-bold text-sm border border-slate-200 shadow-sm">
